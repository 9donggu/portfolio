...
(function ($) {
  ...
  Slider = (function () {
    function Slider (el, settings) {
      ...
      _.defaults = {
        ...
        responsive: true,
        buttons: {
          prev: "<div class='prevmainslide slider-buttons'><span>&#8249;</span></div>",
          next: "<div class='nextmainslide slider-buttons'><span>&#8250;</span></div>"
        }
      }
      _.markup = {
        $slider: $(el),
  ...
  Slider.prototype.setup = function () {
    ...
    if (_.options.navigation === true) {
      ...
      _.markup.$btnprev = _.markup.$slidercontainer.find('.prevmainslide')
      _.markup.$btnnext = _.markup.$slidercontainer.find('.nextmainslide')
